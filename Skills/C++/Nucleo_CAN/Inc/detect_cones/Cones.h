#ifndef _ROS_detect_cones_Cones_h
#define _ROS_detect_cones_Cones_h
...
namespace detect_cones
{

  class Cones : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "detect_cones/Cones"; };
