...
HD_PWD='C:/Users/Aayli/Desktop/rgb2ycbcr/SR_6/SR_6.runs/add_16x16_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add_16x16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add_16x16.tcl
