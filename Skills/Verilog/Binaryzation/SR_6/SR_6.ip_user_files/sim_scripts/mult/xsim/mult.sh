...
#
# Generated by Vivado on Sun Apr 18 14:15:32 +0200 2021
...
# Script info
echo -e "mult.sh - Script generated by export_simulation (Vivado v2018.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xbip_utils_v3_0_9 -L xbip_pipe_v3_0_5 -L xbip_bram18k_v3_0_5 -L mult_gen_v12_0_14 -L xil_defaultlib -L secureip -L xpm --snapshot mult xil_defaultlib.mult -log elaborate.log
}
