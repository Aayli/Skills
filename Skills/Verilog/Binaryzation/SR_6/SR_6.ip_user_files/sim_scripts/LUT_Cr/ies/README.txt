...
#
# Generated by export_simulation on Sun Apr 18 22:54:37 +0200 2021
#
################################################################################
...
'-reset_run' switch to the './LUT_Cr.sh' script.
...
./LUT_Cr.sh -noclean_files

For more information on the script, please type './LUT_Cr.sh -help'.
