...
#
# Generated by export_simulation on Sun Apr 18 14:17:00 +0200 2021
#
################################################################################
...
'-reset_run' switch to the './add_16x16.sh' script.

./add_16x16.sh -reset_run
...
./add_16x16.sh -noclean_files

For more information on the script, please type './add_16x16.sh -help'.
