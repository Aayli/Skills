...
#
# Generated by export_simulation on Sun Apr 18 17:48:58 +0200 2021
#
################################################################################
...
'-reset_run' switch to the './add_17x16.sh' script.

./add_17x16.sh -reset_run
...
./add_17x16.sh -noclean_files

For more information on the script, please type './add_17x16.sh -help'.
