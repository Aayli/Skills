...
#
# Generated by export_simulation on Sun Apr 18 21:57:41 +0200 2021
#
################################################################################
...
'-reset_run' switch to the './add_128.sh' script.

./add_128.sh -reset_run
...
./add_128.sh -noclean_files

For more information on the script, please type './add_128.sh -help'.
